...
function ToComplex(R, I: single): TComplex2;
{ return real part of Z }
// function Real(Z:TComplex2):single;
{ return imag part of Z }
function Imag(Z: TComplex2): single;
...
function IsValidComplexNumber(Z: TComplex2): boolean;
{ retun boolean as string }
function BoolToString(B: boolean): string;
{ convert Complex to a string }
function ComplexToString(Z: TComplex2): string;
{ convert string to a TComplex2 }
function StringToComplex(S: String): TComplex2;

{ Standard operators (+,-,*,/) for complex numbers }

{ add two complex numbers }
function AddZZ(const Z, Z2: TComplex2): TComplex2; inline;
{ add a complex and a real }
function AddZR(const Z: TComplex2; R: single): TComplex2; inline;
{ subtract two complex numbers }

function SubZZ(Z, Z2: TComplex2): TComplex2; inline;
{ subtract Z.re from R (Z - R) }
function SubZR(Z: TComplex2; R: single): TComplex2; inline;
{ subtract R from Z.re (R - Z) }
function SubRZ(R: single; Z: TComplex2): TComplex2; inline;
{ multiply two complex numbers }
function MulZZ(Z, Z2: TComplex2): TComplex2; inline;
{ multiply a real and a complex }
function MulRZ(R: single; Z: TComplex2): TComplex2; inline;
{ divide Z with R ( Z/R ) - let compiler handle divbyzero }
function DivZR(Z: TComplex2; R: single): TComplex2; inline;
{ divide R with Z ( R/Z) - let compiler handle divbyzero }
function DivRZ(R: single; Z: TComplex2): TComplex2; inline;
{ divide two complex numbers }
function DivZZ(Z1, Z2: TComplex2): TComplex2; inline;

{ Specific functions }

{ return absolute value of Z. ( sqrt(x*x + y*y)) }
function AbsZ(Z: TComplex2): single; inline;
{ same as AbsZ }
function ModZ(Z: TComplex2): single; inline;
{ return the argument of Z in radians }
function ArgZ(Z: TComplex2): single;
{ return conjugate of Z (  conjugate( x + iy ) := x - iy ) }
function ConjugateZ(Z: TComplex2): TComplex2;
{ return the square of the absolute value of Z }
function NormZ(Z: TComplex2): single;
{ return negated value of complex number }
function NegZ(Z: TComplex2): TComplex2;
{ test for equality }
function EqualZZ(Z, Z2: TComplex2): boolean;
{ return the cosine of Z }

{ Trig. and hyperbolic functions }

function CosZ(Z: TComplex2): TComplex2;
{ return the hyperbolic cosine of Z }
function CoshZ(Z: TComplex2): TComplex2;
{ return the sine of Z }
function SinZ(Z: TComplex2): TComplex2;
{ return the Arcsine of Z }
function ArcSinZ(Z: TComplex2): TComplex2;
{ return the hyperbolic sine of Z }
function SinhZ(Z: TComplex2): TComplex2;
{ return the hyperbolic arcsine of Z }
function ArcSinhZ(Z: TComplex2): TComplex2;
{ return the tan of Z }
function TanZ(Z: TComplex2): TComplex2;
{ return the arctan of Z }
function ArcTanZ(Z: TComplex2): TComplex2;
{ return the arccos of Z }
function ArcCosZ(Z: TComplex2): TComplex2;
{ retun the hyperbolic tan of Z }
function TanhZ(Z: TComplex2): TComplex2;
{ return the hyperbolic arctan of Z }
function ArcTanhZ(Z: TComplex2): TComplex2;

{ Math. functions }

{ returns e raised to Z  (e^Z) }
function ExpZ(Z: TComplex2): TComplex2; inline;
{ returns the natural log of Z }
function LnZ(Z: TComplex2): TComplex2;
{ retuns the base 10 log of Z }
function Log10Z(Z: TComplex2): TComplex2;
{ return the complex number built from rect.coords. Range and Theta }
function PolarZ(Range, Angle: single): TComplex2;
{ return the rectangular coordinates of Z }
procedure RectangularZ(Z: TComplex2; var Range, Angle: single);
{ return the Square root of Z }
function SqrtZ(Z: TComplex2): TComplex2;
{ return Z^Z2 }
function PowZZ(Z, Z2: TComplex2): TComplex2;
{ return Z^R (R is int) }
function PowZR1(Z: TComplex2; R: integer): TComplex2;
{ return Z^R (R is real) }
function PowZR2(Z: TComplex2; R: single): TComplex2;
{ return R^Z }
function PowRZ(R: single; Z: TComplex2): TComplex2;
...
{ convert string S to a TComplex2 }
{
...
function AddZZ(const Z, Z2: TComplex2): TComplex2;
begin
...
function AddZR(const Z: TComplex2; R: single): TComplex2;
begin
  Result.Re := R + Z.Re;
  Result.Im := Z.Im;
end;
...
function SubZZ(Z, Z2: TComplex2): TComplex2;
begin
  Result.Re := Z.Re - Z2.Re;
  Result.Im := Z.Im - Z2.Im;
end;
...
function SubZR(Z: TComplex2; R: single): TComplex2;
begin
  Result.Re := Z.Re - R;
  Result.Im := Z.Im;
end;
...
function SubRZ(R: single; Z: TComplex2): TComplex2;
begin
  Result := SubZZ(ToComplex(R, 0), Z);
end;

{ multiply two complex numbers: (x + yi) * ( v + wi) = (xv - yw) + i(xw +yv) }
function MulZZ(Z, Z2: TComplex2): TComplex2;
begin
...
function MulRZ(R: single; Z: TComplex2): TComplex2;
begin
  Result.Re := R * Z.Re;
  Result.Im := R * Z.Im;
end;
...
function DivZR(Z: TComplex2; R: single): TComplex2;
begin
  Result.Re := Z.Re / R;
  Result.Im := Z.Im / R;
end;
...
function DivRZ(R: single; Z: TComplex2): TComplex2;
begin
...
function DivZZ(Z1, Z2: TComplex2): TComplex2;
begin
...
{ return absolute value of Z. ( sqrt(x*x + y*y)) }
function AbsZ(Z: TComplex2): single;
var
  x, y: single;
begin
  x := Abs(Z.Re);
...
{ same as AbsZ }
function ModZ(Z: TComplex2): single;
begin
  Result := AbsZ(Z);
end;
...
function ExpZ(Z: TComplex2): TComplex2;
var
  x: single;
begin
  x := Exp(Z.Re);
